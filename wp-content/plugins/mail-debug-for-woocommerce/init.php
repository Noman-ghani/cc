...
if ( !class_exists( 'Mail_Debug_For_WooCommerce' ) ) {
    class Mail_Debug_For_WooCommerce {
        ...
        public function admin_enqueue_scripts() {
            ...
            wp_register_script( 'mdwc-admin-preview', MDWC_ASSETS_URL . '/js/admin-preview.js', array(), MDWC_VERSION );
            wp_register_script( 'mdwc-admin', MDWC_ASSETS_URL . '/js/admin.js', array(), MDWC_VERSION );
